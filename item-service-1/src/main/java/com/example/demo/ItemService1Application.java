...
public class ItemService1Application implements CommandLineRunner {

	private ItemDao itemDao;
	@Autowired
	public ItemService1Application(ItemDao itemDao) {
		this.itemDao = itemDao;
	}

	public static void main(String[] args) {
		SpringApplication.run(ItemService1Application.class, args);
	}
